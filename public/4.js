...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getCv: function getCv() {
      ...
      axios.get("/api/cvs/" + this.$route.params.cvId + "/edit", {
        headers: {
    ...
    updateCv: function updateCv() {
      ...
      axios.put("/api/cvs/" + this.$route.params.cvId, this.cv, {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token")
        }
      }).then(function (response) {
    ...
    deleteEdu: function deleteEdu(key, id) {
      ...
      if (id) {
        axios["delete"]("/cvs/" + this.$route.params.cvId + "/edu/" + id, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token")
          }
        }).then(function (response) {
    ...
    deleteExp: function deleteExp(key, id) {
      ...
      if (id) {
        axios["delete"]("/cvs/" + this.$route.params.cvId + "/exp/" + id, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token")
          }
        }).then(function (response) {
    ...
    deleteSec: function deleteSec(key, id) {
      ...
      if (id) {
        axios["delete"]("/cvs/" + this.$route.params.cvId + "/sec/" + id, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token")
          }
        }).then(function (response) {
    ...
    deleteDateSec: function deleteDateSec(key, id) {
      ...
      if (id) {
        axios["delete"]("/cvs/" + this.$route.params.cvId + "/datedsec/" + id, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token")
          }
        }).then(function (response) {
    ...
    deleteDated: function deleteDated(DataSecID, dataId, keys, key) {
      ...
      if (dataId) {
        axios["delete"]("/datedsec/" + DataSecID + "/datedData/" + dataId, {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token")
          }
        }).then(function (response) {
    ...
    deleteCV: function deleteCV() {
      ...
      axios["delete"]("/cvs/" + this.$route.params.cvId, {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token")
        }
      }).then(function (response) {
              ...
              _c("div", { staticClass: "flex flex-wrap m-2" }, [
                _c(
                  ...
                  [
                    _c(
                      "div",
                      { staticClass: "add-sec m-2" },
                      [
                        _c("div", { staticClass: "dropdown bg-white" }, [
                          _c(
                            "span",
                            {
                              ...
                              fn: function() {
                                return [
                                  _c("div", { staticClass: "form-group" }, [
                                    _c(
                                      "div",
                                      { staticClass: "md:w-4/5 w-full m-auto" },
                                      [
                                        _c("input", {
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.newSec.secHeading,
                                              expression: "newSec.secHeading"
                                            }
                                          ],
                        ...
                        _c("ModelComp", {
                          attrs: {
                            "model-head": "Add custom dated section",
                            id: "add-datedSection"
                          },
                          scopedSlots: _vm._u([
                            {
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c("input", {
                                          directives: [
                                            {
                                              ...
                                              rawName: "v-model",
                                              value:
                                                _vm.newDateSec.datedHeading,
                                              expression:
                                                "newDateSec.datedHeading"
                                            }
                                          ],
                                          staticClass: "form-control",
                                          attrs: {
                                          ...
                                          domProps: {
                                            value: _vm.newDateSec.datedHeading
                                          },
                                          on: {
                                            input: function($event) {
                                              if ($event.target.composing) {
                    ...
                    _c(
                      ...
                      {
                        staticClass: "inf",
                        attrs: { "section-head": "Personal info." }
                      },
                      [
                        _c("div", { staticClass: "form-group" }, [
                          _c(
                ...
                _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      {
                        staticClass: "edu",
                        attrs: { "section-head": "Education" }
                      },
                      [
                        _c("ModelComp", {
                          attrs: {
                            "model-head": "Add Education",
                            id: "add-edu"
                          },
                          scopedSlots: _vm._u([
                            {
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c("ckeditor", {
                                          ...
                                          model: {
                                            value: _vm.edu.edu_des,
                                            callback: function($$v) {
                                              _vm.$set(_vm.edu, "edu_des", $$v)
                                            },
                                            expression: "edu.edu_des"
                                          }
                                        })
                                      ],
                                      1
                        ...
                        _c("div", { staticClass: "add flex justify-end" }, [
                          _c(
                            "span",
                            {
                              staticClass: "text-sm text-blue-400",
                              attrs: {
                                "data-toggle": "modal",
                                "data-target": "#add-edu"
                              }
                    ...
                    _c(
                      ...
                      {
                        staticClass: "exper",
                        attrs: { "section-head": "Experience" }
                      },
                      [
                        _c("ModelComp", {
                          attrs: {
                            "model-head": "Add Experience",
                            id: "add-ex"
                          },
                          scopedSlots: _vm._u([
                            {
                    ...
                    _vm._v(" "),
                    _vm._l(_vm.cv.datedSections, function(vals, keys) {
                      return _c(
                        "SectionComp",
                        {
                          key: "dated-" + keys,
                        ...
                        [
                                              ...
                                              directives: [
                                                {
                                                  name: "model",
                                                  rawName: "v-model",
                                                  value: _vm.data.datedTitle,
                                                  expression: "data.datedTitle"
                                                }
                                              ],
                                              staticClass: "form-control",
                                              attrs: {
                                              ...
                                              directives: [
                                                {
                                                  name: "model",
                                                  rawName: "v-model",
                                                  value: _vm.data.datedOrg,
                                                  expression: "data.datedOrg"
                                                }
                                              ],
                                              staticClass: "form-control",
                                              attrs: {
                          ...
                          _vm._v(" "),
                          _vm._l(_vm.cv.datedSections[keys].data, function(
                            val,
                            key
                          ) {
                          ...
                          _c(
                            "div",
                            {
                              staticClass: "add flex justify-end items-center"
                            },
                            [
                              _c(
                                "span",
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "dropmenu w-100" }, [
      _c(
        "span",
        {
          staticStyle: { "font-weight": "100", color: "#575757" },
          attrs: { "data-toggle": "modal", "data-target": "#add-section" }
        },
        [
          _c("i", { staticClass: "fas fa-plus text-sm mr-1" }),
      ...
      _c(
        ...
        {
          staticStyle: { "font-weight": "100", color: "#575757" },
          attrs: { "data-toggle": "modal", "data-target": "#add-datedSection" }
        },
        [
          _c("i", { staticClass: "fas fa-plus text-sm mr-1" }),
