  ...
  methods: {
    ...
    register: function register() {
      ...
      axios.post("/register", this.$data).then(function (response) {
        ...
        _this.$router.push('/dashboard'); // console.log(response);
...
window.Vue = Vue;
window.Vuex = vuex__WEBPACK_IMPORTED_MODULE_1__["default"]; // Vue.config.productionTip = false
...
Vue.filter('formatDate', function (value) {
  if (value) {
    return moment__WEBPACK_IMPORTED_MODULE_3___default()(String(value)).calendar();
  }
});
...
var Cvs = function Cvs() {
  return __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./views/CVS.vue */ "./resources/js/views/CVS.vue"));
};

var Create = function Create() {
  return Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(0), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, /*! ./views/Create.vue */ "./resources/js/views/Create.vue"));
};

var Show = function Show() {
  return Promise.all(/*! import() */[__webpack_require__.e(1), __webpack_require__.e(0), __webpack_require__.e(4)]).then(__webpack_require__.bind(null, /*! ./views/Show.vue */ "./resources/js/views/Show.vue"));
};
...
router.beforeEach(function (to, from, next) {
  ...
  }) && !_store__WEBPACK_IMPORTED_MODULE_1__["default"].state.isLoggedIn) {
    next('auth');
    return;
  } // if logged in redirect to dashboard


  if (to.path === '/auth' && _store__WEBPACK_IMPORTED_MODULE_1__["default"].state.isLoggedIn) {
    next('dashboard');
    return;
  }
...
__webpack_require__(/*! D:\Main\laravel projects\Loki\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Main\laravel projects\Loki\resources\sass\app.scss */"./resources/sass/app.scss");
