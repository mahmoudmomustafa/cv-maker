...
Vue.filter('formatDate', function (value) {
  if (value) {
    return moment__WEBPACK_IMPORTED_MODULE_2___default()(String(value)).calendar();
  }
});
...
var Auth = function Auth() {
  return Promise.all(/*! import() */[__webpack_require__.e(3), __webpack_require__.e(8)]).then(__webpack_require__.bind(null, /*! ./views/Auth.vue */ "./resources/js/views/Auth.vue"));
};
...
var store = new Vuex.Store({
  ...
  actions: {
    ...
    GET_CVS: function GET_CVS(_ref3) {
      ...
      return new Promise(function (resolve, reject) {
        axios.get("/api/cvs").then(function (response) {
