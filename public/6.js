...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteDated: function deleteDated(DataSecID, dataId, keys, key) {
      ...
      axios["delete"]("/datedsec/" + sec + "/datedData/" + dataId).then(function (response) {
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.newDateSec.datedTitle,
                                              expression:
                                                "newDateSec.datedTitle"
                                            }
                                          ],
                                          staticClass: "form-control",
                                          attrs: {
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.newDateSec.datedOrg,
                                              expression: "newDateSec.datedOrg"
                                            }
                                          ],
                                          staticClass: "form-control",
                                          attrs: {
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c("ckeditor", {
                                          ...
                                          model: {
                                            value: _vm.newDateSec.datedDesc,
                                            callback: function($$v) {
                                              _vm.$set(
                                                _vm.newDateSec,
                                                "datedDesc",
                                            ...
                                            expression: "newDateSec.datedDesc"
                                          }
                                        })
                                      ],
                                      1
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.newDateSec.startDate,
                                              expression: "newDateSec.startDate"
                                            }
                                          ],
                                          staticClass: "form-control",
                                          attrs: {
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: _vm.newDateSec.endDate,
                                              expression: "newDateSec.endDate"
                                            }
                                          ],
                                          staticClass: "form-control",
                                          attrs: {
